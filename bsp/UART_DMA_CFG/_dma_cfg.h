...
//
#define   RECE_BUF_MAX_LEN       (1024+256)
#define   SENT_BUF_MAX_LEN       (1024+1024)
  
/* UART Events */
#define HAL_UART_RX_FULL         0x01
#define HAL_UART_RX_TIMEOUT      0x02
  
#define HAL_LPUART_RX_FULL       0x01
#define HAL_LPUART_RX_TIMEOUT    0x02
#define HAL_UART2_RX_FULL        0x04
#define HAL_UART2_RX_TIMEOUT     0x08
...
//函数声明区域
//
typedef void (*sendData_cb)(uint8_t type,uint8_t* buf,uint16_t len); 
...
extern uint8_t* UartDma_Init(uint8_t type,sendData_cb,USART_TypeDef*);
...
//******************************************************************************
extern uint16_t UartDma_Read(uint8_t type,uint8_t *buf, uint16_t len);
...
//******************************************************************************
extern uint16_t UartDma_Write(uint8_t type,uint8_t *buf, uint16_t len);
//**************************************************************************************************
// fn  :  UartDma_Avail
//
