...
/*
	安富莱STM32-V5 开发板口线分配
	PB3/SPI3_SCK/SPI2_SCK
	PB4/SPI3_MISO/SPI2_MISO
	PB5/SPI3_MOSI/SPI2_MOSI

	STM32硬件SPI接口 = SPI3 或者 SPI2
	由于SPI2的时钟源是84M, SPI3的时钟源是42M。为了获得更快的速度，软件上选择SPI2。
*/
