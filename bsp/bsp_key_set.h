...
#ifndef __BSP_KEY_SET_H
#define __BSP_KEY_SET_H

#include "stm32l4xx_hal.h"

#define KEY_SET_COUNT    2 					/* 按键个数, 8个独立建 + 2个组合键 */
...
#define KEY_SET_FILTER_TIME   5//5ms
#define KEY_SET_LONG_TIME     200/* 单位10ms， 持续3秒，认为长按事件 */
...
#define KEY_DOWN_SURE		KEY_1_DOWN		/* 确定 */
#define KEY_UP_SURE			KEY_1_UP
#define KEY_LONG_SUREU		KEY_1_LONG
