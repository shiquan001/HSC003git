...
#define B_LUX_SCL0_H    HAL_GPIO_WritePin(IIC1_SCL_GPIO_Port, IIC1_SCL_Pin, GPIO_PIN_SET) 
#define B_LUX_SCL0_L    HAL_GPIO_WritePin(IIC1_SCL_GPIO_Port, IIC1_SCL_Pin, GPIO_PIN_RESET)  		
*/
...
static void i2c_Delay(void)
{
	...
	*/
//	for (i = 0; i < 30; i++);
	for (i = 0; i < 120; i++); //reduce the iic speed
}
