...
typedef enum
{
  TYPES_CIMI = MSG_IMSI,
  TYPES_CGSN = MSG_IMEI,
  TYPES_ICCID = MSG_ICCID,

  TYPES_NUESTATS = MSG_NUESTATS,  
...
extern const char* bc95_getIMEI(NB_Handle handle);
extern const char* bc95_getICCID(NB_Handle handle);

extern int bc95_getSignalPower(void);
extern int bc95_getSNR(void);
extern int bc95_getECL(void);
extern int bc95_getCellID(void);
...
extern void nb_read_message(void);
